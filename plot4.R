plot4 <- function()
{
  ...
  plot(as.numeric(data$Voltage)~data$Datetime, type="l",ylab="Voltage", xlab="datetime")
  ...
  plot(as.numeric(data$Global_reactive_power)~data$Datetime, type="l",ylab="Global Reactive Power", xlab="datetime")
